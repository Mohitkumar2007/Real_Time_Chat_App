...
class MessageSerializer(serializers.Serializer):
    ...
    reply_to_message_id = serializers.CharField(required=False, allow_blank=True, max_length=64)
    reply_to_text = serializers.CharField(read_only=True, required=False)
    reply_to_sender_user_id = serializers.CharField(read_only=True, required=False)
