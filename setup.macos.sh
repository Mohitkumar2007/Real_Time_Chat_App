...
PYTHON_BIN="backend/Pro_venv/bin/python"

if [ ! -f "$PYTHON_BIN" ]; then
  echo "Creating Python virtual environment at backend/Pro_venv"
  python3 -m venv "backend/Pro_venv"
fi
...
echo "Run bash run.macos.sh to start backend and frontend."
